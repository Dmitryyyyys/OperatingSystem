...
int main()
{
	...
	processes[0] = createProcess(L"C:\\labs\\ОС\\OS06_03A\\x64\\Debug\\OS06_03A.exe").hProcess;
	processes[1] = createProcess(L"C:\\labs\\ОС\\OS06_03B\\x64\\Debug\\OS06_03B.exe").hProcess;
