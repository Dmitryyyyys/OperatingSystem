...
int main()
{
	...
	processes[0] = createProcess(L"C:\\labs\\ОС\\OS06_04A\\x64\\Debug\\OS06_04A.exe").hProcess;
	processes[1] = createProcess(L"C:\\labs\\ОС\\OS06_04B\\x64\\Debug\\OS06_04B.exe").hProcess;
