...
int main()
{
	...
	processes[0] = createProcess(L"C:\\labs\\ОС\\OS06_05A\\x64\\Debug\\OS06_05A.exe").hProcess;
	processes[1] = createProcess(L"C:\\labs\\ОС\\OS06_05B\\x64\\Debug\\OS06_05B.exe").hProcess;
